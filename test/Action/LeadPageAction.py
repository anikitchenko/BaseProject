...
class LeadPageAction(object):
    ...
    def __click_delete_lead_button(self):
        self.driver.find_element_by_css_selector(LeadPageSelector.DELETE_LEAD_BUTTON).click()

    def __accept_delete_lead(self):
        self.driver.execute_script("document.querySelector('{selector}').click()".
                                   format(selector=LeadPageSelector.ACCEPT_DELETE_LEAD_BUTTON))
